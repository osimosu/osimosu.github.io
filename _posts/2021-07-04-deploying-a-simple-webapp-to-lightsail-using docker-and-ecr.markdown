---
layout: "post"
title:  "Deploying a Simple Webapp to Lightsail Using Docker and ECR"
...
on [Amazon Lightsail](https://aws.amazon.com/lightsail/){:target="_blank"}
with [Amazon Elastic Container Registry (ECR)](https://aws.amazon.com/ecr/){:target="_blank"}.

There are many ways to deploy web apps to AWS with different use cases and pricing models, but what if you have a small
webapp you want to deploy rapidly, manage and scale on a cheap monthly plan? Lightsail is an excellent choice! It is
...
More than enough for a pet project with little traffic!
...
Done! Your application should available on `http://<instance public ip>:<host post>`!
